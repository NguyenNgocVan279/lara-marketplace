...
Route::get('/ads-pending', 'App\Http\Controllers\AdvertisementController@pendingAds')->name('ads.pending')->middleware('auth');
...
Route::get('/ad/remove','App\Http\Controllers\SaveAdController@removeAd')->name('ad.remove');
